...
import Dijkstra from './pathfinding/1_the_basics/3_Dijkstra';
import Dijkstra2 from './pathfinding/1_the_basics/3_2_Dijkstra';
import DijkstrasAlgo from './pathfinding/1_the_basics/4_Dijkstras_algo';
import aStar from './pathfinding/1_the_basics/5_a_star';
...
export { Welcome, WhatIsPathfinding, Applications, Dijkstra, Dijkstra2, DijkstrasAlgo, aStar, inputOutput, distanceBetweenNodes };